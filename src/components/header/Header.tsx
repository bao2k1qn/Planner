...
const Header = () => {
    return (
        <div className="sticky top-0 w-full backdrop-blur transition-colors duration-500 z-10 border-b border-slate-900/10 dark:border-slate-50/[0.06] overflow-hidden">
            <div className="max-w-screen-2xl mx-auto px-14 h-14 bg-white/80 backdrop-blur dark:bg-slate-900/80 flex justify-between md:px-4">
